...
export function SkeletonCard() {
  return (
    <div className="px-6 py-4 bg-[rgba(0,_0,_0,_0.10)] rounded-3xl flex gap-2 w-full max-w-[640px]">
      ...
      <div className="flex flex-col gap-2 flex-1 items-start w-full">
        <div className="w-32 h-4 rounded-md bg-[rgba(0,_0,_0,_0.6)] animate-pulse"></div>
